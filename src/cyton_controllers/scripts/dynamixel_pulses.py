...
from dynamixel_msgs.msg import MotorState as MotorStateDynamixel
...
class MotorsStatePublisher():
    def __init__(self):

        rospy.init_node('dynamixel_pulses', anonymous=True)
